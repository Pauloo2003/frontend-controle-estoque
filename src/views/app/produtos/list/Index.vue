<template>
  ...
  <div>
    ...
    />
    <ModalAtt
        idModal="modal-att-produto"
        titleModal="Atualizar Produto"
    ...
    >
      <template #message>
        <div>
          <p>Tem certeza que deseja deletar essa Produto?</p>
        </div>
      </template>
    </modal-confirmation>
  ...
  methods: {
    ...
    resetFormData() {
      ...
      this.dataProduto = {
        ...
        usuarioid: '',
        tipousuarioid: '',
        tipopicreserva: false,
        tipopiccliente: false,
        tipopicrede: false,
        tabelapreco: false,
        tabprecoid: '',
      }
